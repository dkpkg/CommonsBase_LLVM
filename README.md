...
docker run -v .:/work --workdir /work -it quay.io/pypa/manylinux_2_28_x86_64:2026.04.08-5 sh ./dk0 -nosysinc -v -v distribute CommonsBase_LLVM-dist-linux --library CommonsBase_LLVM@2.5.999911122233 --actual-in-place dist-linux.u
```
